...
function Reservas() {
  ...
  return (
    <div id="comanda-reservas-section" style={{ padding: "30px", backgroundColor: "#fdfdfd", minHeight: "100vh" }}>
      ...
      {/* HEADER */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "35px", borderBottom: "1px solid #eee", paddingBottom: "20px" }}>
        <div>
          ...
          <p style={{ color: "#888", fontSize: "0.9rem", margin: "5px 0 0 0" }}>
            Gestiona las visitas para {restauranteActivo}
          </p>
        </div>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          {fechaFiltro && (
            <button onClick={() => setFechaFiltro("")}
              style={{ background: "none", border: "none", color: "#ff6b00", cursor: "pointer", fontWeight: 700, fontSize: "0.8rem" }}>
              Limpiar
            </button>
          )}
        </div>
      ...
      <div className="row g-4">
        ...
        {filtradas.length === 0 && (
          <div className="col-12 text-center py-5 text-muted">
            ...
            <p className="mt-2">No hay reservas para este filtro.</p>
          </div>
        )}
      </div>
    </div>
