    ...
    return (
      <div id="final-success-wrapper">
        <div style={{ background: "white", padding: "50px", borderRadius: "15px", textAlign: "center", maxWidth: 520, margin: "60px auto", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
          ...
          <p style={{ color: "#666" }}>El restaurante <strong>{form.nombre}</strong> ha sido dado de alta en el sistema.</p>
          <button 
    ...
    <div id="comanda-form-container-v4">
      ...
      <div id="restaurante-form-card-unique" style={{ background: "white", padding: "35px", borderRadius: "20px", maxWidth: 860, margin: "0 auto", boxShadow: "0 4px 25px rgba(0,0,0,0.06)" }}>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "25px", borderBottom: "1px solid #f0f0f0", paddingBottom: "20px" }}>
            ...
            <div className="row g-3">
              <div className="col-md-5">
                ...
                <input 
                  name="distrito" 
                  list="lista-distritos-v4" 
                  value={form.distrito} 
                  onChange={handle} 
                  style={inputStyle("distrito")} 
                  placeholder="Escribe o selecciona lugar..."
                />
          ...
          {/* SECCIÓN 3: MULTIMEDIA Y CONTACTO */}
          <div style={{ marginBottom: "25px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end", marginTop: "10px" }}>
            <button 
              type="button" 
              onClick={() => { setForm(initialForm); setPreview(null); }}
              style={{ padding: "12px 25px", borderRadius: "10px", border: "1px solid #e8e0d8", background: "white", color: "#999", fontWeight: "600", cursor: "pointer" }}
            >
              Limpiar
            </button>
            <button 
              type="submit" 
              style={{ padding: "12px 35px", borderRadius: "10px", border: "none", background: "#ff6b00", color: "white", fontWeight: "700", cursor: "pointer", boxShadow: "0 4px 12px rgba(255, 107, 0, 0.2)" }}
            >
              Finalizar Registro
            </button>
          </div>
